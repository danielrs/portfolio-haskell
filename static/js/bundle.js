                      ...
                      return (function () {
                          var onScroll = function __do() {
                              ...
                              return (function () {
                                  ...
                                  throw new Error("Failed pattern match at UI.Import line 43, column 17 - line 49, column 9: " + [ _10.constructor.name ]);
                              })()();
                          };
                          return function __do() {
...
(function(exports) {
  ...
  var smoothScrollMain = function __do() {
      var _16 = Control_Monad_Eff_JQuery.select("html, body")();
      var _15 = Control_Monad_Eff_JQuery.select("#main-nav")();
      var _14 = Control_Monad_Eff_JQuery.select("#main-nav ul li a, #go-page-top")();
      return (function () {
          var clicked = function (event) {
              return function (link) {
                  return function __do() {
                      var _13 = UI_Import.getAttr("href")(link)();
                      return (function () {
                          var _27 = Data_Foreign.readString(_13);
                          ...
                          if (_27 instanceof Data_Either.Right) {
                              return function __do() {
                                  ...
                                  var _12 = UI_Import.height(_15)();
                                  var _11 = Prelude[">>="](Control_Monad_Eff.bindEff)(Control_Monad_Eff_JQuery.select(_27.value0))(UI_Import.offset)();
                                  Prelude[">>="](Control_Monad_Eff.bindEff)(UI_Import.animateStop(_16))(UI_Import.animate({
                                      scrollTop: _11.top - _12 - 16
                                  })(250))();
                                  return Prelude["return"](Control_Monad_Eff.applicativeEff)(Prelude.unit)();
                              };
                          };
                          throw new Error("Failed pattern match at UI.Navigation line 80, column 13 - line 91, column 9: " + [ _27.constructor.name ]);
                      })()();
                  };
              };
          };
          return function __do() {
              Control_Monad_Eff_JQuery.on("click")(clicked)(_14)();
              return Prelude["return"](Control_Monad_Eff.applicativeEff)(Prelude.unit)();
          };
      })()();
  };
  var navbarMain = function __do() {
      var _8 = UI_Import.window();
      var _7 = UI_Import.document();
      var _6 = Control_Monad_Eff_JQuery.select("#main-nav-wrapper")();
      var _5 = Control_Monad_Eff_JQuery.select("#main-nav")();
      var _4 = Control_Monad_Eff_JQuery.select("#main-nav__toggle")();
      var _3 = UI_Import.createEl("div")({
          id: "main-nav-checkpoint"
      })();
      Control_Monad_Eff_JQuery.before(_3)(_6)();
      var _2 = UI_Import.createEl("div")({
          "class": "mirror", 
          id: "main-nav-mirror"
      })();
      Control_Monad_Eff_JQuery.before(_2)(_6)();
      var updateHeight = function __do() {
          var _1 = UI_Import.height(_5)();
          Control_Monad_Eff_JQuery.css({
              height: _1
          })(_6)();
          var _0 = UI_Import.outerHeight(true)(_6)();
          return Control_Monad_Eff_JQuery.css({
              height: _0
          })(_2)();
      };
      var toggled = function (_19) {
          return function (_20) {
              return function __do() {
                  Control_Monad_Eff_JQuery.toggleClass("main-nav-wrapper--hide-nav")(_6)();
                  return updateHeight();
              };
          };
      };
      var scrolledBefore = function __do() {
          Control_Monad_Eff_JQuery.removeClass("main-nav-wrapper--fixed")(_6)();
          Control_Monad_Eff_JQuery.css({
              display: "none"
          })(_2)();
          return updateHeight();
      ...
      var scrolledAfter = function __do() {
          Control_Monad_Eff_JQuery.addClass("main-nav-wrapper--fixed")(_6)();
          Control_Monad_Eff_JQuery.css({
              display: "block"
          })(_2)();
          return updateHeight();
      };
      UI_Import.onScrollCheckpoint(75)(scrolledBefore)(scrolledAfter)(_3)();
      Control_Monad_Eff_JQuery.on("click")(toggled)(_4)();
      Control_Monad_Eff_JQuery.on("resize")(UI_Import.eventThrottled(Control_Monad_Eff_Throttle.throttle(75)(updateHeight)))(_8)();
      return Prelude["return"](Control_Monad_Eff.applicativeEff)(Prelude.unit)();
  };
  var languageChangeMain = function __do() {
      var _18 = Control_Monad_Eff_JQuery.select("#footer-lang form")();
      var _17 = Control_Monad_Eff_JQuery.find("select")(_18)();
      Prelude[">>="](Control_Monad_Eff.bindEff)(Control_Monad_Eff_JQuery.find("input[type=submit]")(_18))(Control_Monad_Eff_JQuery.remove)();
      var changed = function (_21) {
          return function (_22) {
              return UI_Import.submit(_18);
          };
      };
      Control_Monad_Eff_JQuery.on("change")(changed)(_17)();
      return Prelude["return"](Control_Monad_Eff.applicativeEff)(Prelude.unit)();
  };
  var goTopMain = function __do() {
      var _10 = Control_Monad_Eff_JQuery.select("#go-page-top")();
      var _9 = Control_Monad_Eff_JQuery.select("#main-nav-checkpoint")();
      return (function () {
          var scrolledBefore = Control_Monad_Eff_JQuery.addClass("go-page-top--hide")(_10);
          var scrolledAfter = Control_Monad_Eff_JQuery.removeClass("go-page-top--hide")(_10);
          return function __do() {
              UI_Import.onScrollCheckpoint(75)(scrolledBefore)(scrolledAfter)(_9)();
              return Prelude["return"](Control_Monad_Eff.applicativeEff)(Prelude.unit)();
          };
      })()();
  };
